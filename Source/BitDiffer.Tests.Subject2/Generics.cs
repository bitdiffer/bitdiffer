...
namespace BitDiffer.Tests.Subject
{
	...
	public class GenericClassAddsArg<T, U>
	{
		public string Foo()
		{
			return "hi";
	...
	public class GenericClassAddsRestriction<T> where T : ICancelAddNew
	{
		public string Foo()
		{
			return "hi";
	...
	{
		public string Foo<T>(T x) where T : ISupportInitialize
		{
			return x.ToString();
		}
	}
